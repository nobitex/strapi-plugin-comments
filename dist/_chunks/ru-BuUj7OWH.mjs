const e = {
  ...
  "nav.header.settings": "Настройки",
  "nav.item.updates": "Обновления",
  "nav.item.discover": "Поиск",
  "nav.item.reports": "Отчеты",
  "nav.item.settings": "Настройки",
  "page.auth.noAccess": "Нет доступа",
  "page.auth.not.allowed": "Ой-ой! Кажется у вас нет доступа к этой странице...",
  "page.common.item.status.OPEN": "Открыть",
  "page.common.item.status.PENDING": "В ожидании",
  "page.common.item.status.BLOCKED": "Заблокирован",
  "page.common.item.status.APPROVED": "Утвержден",
  "page.common.item.status.RESOLVED": "Закрыт",
  "page.common.item.status.TO_REVIEW": "К рассмотрению ({count, number})",
  "page.common.item.status.REJECTED": "Отклонен",
  "page.common.item.status.REMOVED": "Удален автором",
  ...
  "page.discover.table.header.lastUpdate": "Последние обновление",
  "page.discover.table.header.status": "Статус",
  "page.discover.table.header.actions": "Действия",
  "page.discover.table.cell.thread": "Комментарий #{id}",
  "page.discover.table.action.display": "Показать",
  "page.discover.table.action.reports": "Отчеты",
  "page.discover.table.empty": "Комментариев пока нет.",
  "page.discover.table.empty.search": "По поисковому запросу ничего не найдено.",
  "page.discover.table.filters": "Фильтрация",
  "page.discover.table.reports.review": "Посмотреть отчеты",
  "page.reports.header": "Отчеты",
  "page.reports.table.empty": "Отчетов пока нет.",
  "page.reports.table.empty.search": "По поисковому запросу ничего не найдено.",
  "page.reports.table.header.id": "ID",
  "page.reports.table.header.reason": "Причина",
  "page.reports.table.header.content": "Содержимое",
  "page.reports.table.header.status": "Статус",
  "page.reports.table.header.issueDate": "Дата проблемы",
  "page.reports.table.header.relatedComment": "Связанный комментарий",
  "page.reports.table.header.actions": "Действия",
  "page.reports.table.cell.action.resolve": "разрешено",
  "page.reports.table.cell.action.block": "Заблокировать",
  "page.details.header": "Панель обсуждений",
  "page.details.header.description": "Детали и управление обсуждением, связанным с сущностью",
  "page.details.header.description.empty": "Эта запись была удалена",
  "page.details.panel.discussion": "Обсуждение",
  "page.details.panel.discussion.nav.drilldown": "Детали",
  "page.details.panel.discussion.nav.back": "Наверх",
  ...
  "page.details.panel.discussion.warnings.reports.dialog.reason.BAD_LANGUAGE": "Ругательства",
  "page.details.panel.discussion.warnings.reports.dialog.reason.DISCRIMINATION": "Дискриминация",
  "page.details.panel.discussion.warnings.reports.dialog.reason.OTHER": "Другое",
  "page.details.panel.discussion.warnings.reports.dialog.content": "Содержимое",
  "page.details.panel.discussion.warnings.reports.dialog.createdAt": "Дата проблемы",
  "page.details.panel.discussion.warnings.reports.dialog.status": "Статус",
  "page.details.panel.discussion.warnings.reports.dialog.status.OPEN": "Открыть",
  ...
  "page.details.panel.discussion.send": "Отправить модератору ответ",
  "page.details.actions.comment.post.confirmation": "Комментарий отправлен",
  "page.details.actions.comment.update.confirmation": "Комментарий обновлен",
  "page.details.panel.entity": "Детали сущности",
  "page.details.panel.status": "Обсуждение",
  "page.details.panel.status.open": "Открыто",
  "page.details.panel.status.blocked": "Заблокировано",
  "page.details.panel.status.pending": "Ожидает",
  ...
  "page.details.actions.comment.unblock.confirmation.success": "Комментарий разблокирован",
  "page.details.actions.comment.delete": "Удалить комментарий",
  "page.details.actions.comment.delete.confirmation.success": "Комментарий удален",
  ...
  "page.details.actions.thread.unblock.confirmation.success": "Тема разблокирована",
  "page.details.actions.thread.modal.start.thread": "Создать тему",
  ...
  "page.settings.header.title": "Комментарии",
  "page.settings.header.description": "Настройки возможности модерации комментариев",
  "page.settings.actions.submit": "Сохранить",
  "page.settings.actions.restore": "Восстановить настройки по-умолчанию",
  "page.settings.actions.restart": "Перезапустить Strapi",
  "page.settings.section.general": "Основные настройки",
  ...
  "components.confirmation.dialog.button.cancel": "Отмена",
  "components.toogle.enabled": "Включено",
  "components.toogle.disabled": "Отключено",
  "components.author.unknown": "Автор удален",
  "components.reason.unknown": "Причина не предоставлена",
  "components.content.unknown": "Содержимое не предоставлено",
  "components.notAccessPage.back": "Назад на домашнюю страницу",
  "customField.comments.label": "Комментарии",
  "customField.comments.description": "Укажите параметры запроса для комментариев",
  "customField.comments.input.commentsNumber.label": "Количество комментариев",
  "customField.comments.input.renderType.label": "Выводить комментарии в виде",
  "customField.comments.input.renderType.option.tree.label": "Дерева",
  "customField.comments.input.renderType.option.flat.label": "Списком",
  "customField.comments.input.sortByDate.label": "Отсортировать по дате создания",
  "customField.comments.input.sortByDate.option.asc.label": "По возрастанию",
  "customField.comments.input.sortByDate.option.desc.label": "По убыванию",
  "customField.comments.input.filterBy.label": "Отобрать по",
  "customField.comments.input.filterBy.option.dateCreated.label": "Дате создания",
  "customField.comments.input.filterBy.option.dateCreated.label.details.label": "Укажите дату",
  "customField.comments.input.filterBy.option.approvalStatus.label": "Статус согласования",
  "customField.comments.input.filterBy.option.approvalStatus.label.details.label": "Укажите статус",
  "customField.comments.input.filterBy.option.approvalStatus.option.pending.label": "Ожидание",
  "customField.comments.input.filterBy.option.approvalStatus.option.approved.label": "Утверждено",
  "customField.comments.input.filterBy.option.approvalStatus.option.rejected.label": "Отклонено",

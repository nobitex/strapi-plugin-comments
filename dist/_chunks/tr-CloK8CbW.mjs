const e = {
  "plugin.name": "Yorum",
  "plugin.section": "Yorum eklentisi",
  "plugin.section.item": "Konfigürasyon",
  "common.button.back": "Geri",
  "nav.header.moderation": "Yönetim",
  "nav.header.settings": "Ayarlar",
  "nav.item.updates": "Güncellemeler",
  "nav.item.discover": "Keşfet",
  "nav.item.reports": "Raporlananlar",
  "nav.item.settings": "Ayarlar",
  "page.auth.noAccess": "Erişim Yok",
  "page.auth.not.allowed": "Oops! Görünüşe göre bu sayfaya erişiminiz yok ...",
  "page.common.item.status.OPEN": "Açık",
  "page.common.item.status.PENDING": "Onay Bekliyor",
  "page.common.item.status.BLOCKED": "Engelli",
  "page.common.item.status.APPROVED": "Onaylı",
  "page.common.item.status.RESOLVED": "Çözüldü",
  "page.common.item.status.TO_REVIEW": "İncelenecek ({count, number})",
  "page.common.item.status.REJECTED": "Reddedilmiş",
  "page.common.item.status.REMOVED": "Yazar kaldırdı",
  ...
  "page.discover.table.header.lastUpdate": "Son güncelleme",
  "page.discover.table.header.status": "Durum",
  "page.discover.table.header.actions": "Düzenle",
  "page.discover.table.cell.thread": "Yorum #{id}",
  "page.discover.table.action.display": "Görüntüle",
  "page.discover.table.action.reports": "Raporlananlar",
  "page.discover.table.empty": "Henüz yorumunuz yok.",
  "page.discover.table.empty.search": "Aramaya uygun yorum bulunamadı.",
  "page.discover.table.filters": "Filtreleme",
  "page.discover.table.reports.review": "Raporlananları incele",
  "page.reports.header": "Raporlananları çöz",
  "page.reports.table.empty": "Henüz herhangi bir raporunuz yok.",
  "page.reports.table.empty.search": "Hiçbir rapor aramaya uymuyor.",
  "page.reports.table.header.id": "ID",
  "page.reports.table.header.reason": "Sebep",
  "page.reports.table.header.content": "İçerik",
  "page.reports.table.header.status": "Durum",
  "page.reports.table.header.issueDate": "Düzenleme tarihi",
  "page.reports.table.header.relatedComment": "İlgili yorum",
  "page.reports.table.header.actions": "Düzenle",
  "page.reports.table.cell.action.resolve": "çözüldü",
  "page.reports.table.cell.action.block": "Engelle",
  "page.details.header": "Tartışma paneli",
  "page.details.header.description": "Varlıkla ilgili tartışmayı ve tartışmayı yönetin",
  "page.details.header.description.empty": "Bu giriş silinmiştir",
  "page.details.panel.discussion": "Tartışma",
  "page.details.panel.discussion.nav.drilldown": "Derinlemesine",
  "page.details.panel.discussion.nav.back": "Yukarı git",
  ...
  "page.details.panel.discussion.warnings.reports.dialog.reason.BAD_LANGUAGE": "Kötü dil",
  "page.details.panel.discussion.warnings.reports.dialog.reason.DISCRIMINATION": "Ayrımcılık",
  "page.details.panel.discussion.warnings.reports.dialog.reason.OTHER": "Diğer",
  "page.details.panel.discussion.warnings.reports.dialog.content": "İçerik",
  "page.details.panel.discussion.warnings.reports.dialog.createdAt": "Düzenleme tarihi",
  "page.details.panel.discussion.warnings.reports.dialog.status": "Durum",
  "page.details.panel.discussion.warnings.reports.dialog.status.OPEN": "Açık",
  ...
  "page.details.panel.discussion.send": "Gönder",
  "page.details.actions.comment.post.confirmation": "Yorum yayınlandı",
  "page.details.actions.comment.update.confirmation": "Yorum güncellendi",
  "page.details.panel.entity": "Varlık detayları",
  "page.details.panel.status": "Tartışma",
  "page.details.panel.status.open": "Açık",
  "page.details.panel.status.blocked": "Engellenmiş",
  "page.details.panel.status.pending": "Onay bekliyor",
  ...
  "page.details.actions.comment.unblock.confirmation.success": "Yorumun engeli açıldı",
  "page.details.actions.comment.delete": "Yorumu sil",
  "page.details.actions.comment.delete.confirmation.success": "Yorum silindi",
  ...
  "page.details.actions.thread.unblock.confirmation.success": "Başlık engellendi",
  "page.details.actions.thread.modal.start.thread": "Başlık aç",
  ...
  "page.settings.header.title": "Yorumlar",
  ...
  "page.settings.notification.submit.error": "Yapılandırmayı kaydedemedi. Tekrar deneyin.",
  ...
  "components.toogle.disabled": "Deaktif",
  "components.author.unknown": "Yazar kaldırıldı",
  "components.reason.unknown": "Sebep sağlanmadı",
  "components.content.unknown": "İçerik sağlanmadı",
  "components.notAccessPage.back": "Ana sayfaya geri dön",
  "customField.comments.label": "Yorumlar",
  "customField.comments.description": "Yorumlar için query parametrelerini girin",
  "customField.comments.input.commentsNumber.label": "Yorum sayısı",
  "customField.comments.input.renderType.label": "Yorumlar",
  "customField.comments.input.renderType.option.tree.label": "Ağaç",
  "customField.comments.input.renderType.option.flat.label": "Düz liste",
  "customField.comments.input.sortByDate.label": "Yaratılış tarihine göre sıralayın",
  "customField.comments.input.sortByDate.option.asc.label": "Artan",
  "customField.comments.input.sortByDate.option.desc.label": "Azalan",
  "customField.comments.input.filterBy.label": "Filtrele:",
  "customField.comments.input.filterBy.option.dateCreated.label": "Oluşturulma tarihi",
  "customField.comments.input.filterBy.option.dateCreated.label.details.label": "Tarih belirt",
  "customField.comments.input.filterBy.option.approvalStatus.label": "Onay durumu",
  "customField.comments.input.filterBy.option.approvalStatus.label.details.label": "Durumu belirt",
  "customField.comments.input.filterBy.option.approvalStatus.option.pending.label": "Onay bekliyor",
  "customField.comments.input.filterBy.option.approvalStatus.option.approved.label": "Onaylı",
  "customField.comments.input.filterBy.option.approvalStatus.option.rejected.label": "Reddedilmiş",
